...
public class WW3PlusWindLast3DaysStrategy implements GenerationStrategy {
	...
	public WW3PlusWindLast3DaysStrategy() {
		this.name = "WW3PlusWindLast3DaysStrategy";
		this.description = 
			"Esta estrategia usa los datos del ww3 (en este caso datos de las olas y de los vientos) y los combina con las observaciones visuales.\n" +
	...
	public WW3PlusWindLast3DaysStrategy(String beach, String[]years, double ww3Y, double ww3X) {
		this();
		this.beach = beach;
		this.shortDescription = "strategy[WW3PlusWindLast3Days].beach[" + beach + "].years " + Arrays.toString(years) + ".months[1-12].height[unrestriced].ww3.1[" + ww3Y + "," + ww3X+"]";
	}
	@Override
	...
	private Vector<ArfData> mergeData(Vector<WaveWatchData> ww3DataSet, Vector<ObsData> obsDataSet){
		...
		for (int i = 2; i < ww3DataSet.size(); i++){
			...
			if (obsData != null){
				...
				data.put("ww3WindDirection", ww3Data.getWindDirection());
				data.put("ww3WindSpeed", ww3Data.getWindSpeed());
				
				data.put("ww3Height1DayPrev", ww3Data1DayPrev.getHeight());
				data.put("ww3Period1DayPrev", ww3Data1DayPrev.getPeriod());
				data.put("ww3Direct1DayPrev", ww3Data1DayPrev.getDirection());
				data.put("ww3WindDirection1DayPrev", ww3Data1DayPrev.getWindDirection());
				data.put("ww3WindSpeed1DayPrev", ww3Data1DayPrev.getWindSpeed());
				...
				data.put("ww3WindDirection2DayPrev", ww3Data2DayPrev.getWindDirection());
				data.put("ww3WindSpeed2DayPrev", ww3Data2DayPrev.getWindSpeed());
