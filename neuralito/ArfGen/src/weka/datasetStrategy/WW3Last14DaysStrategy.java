...
public class WW3Last14DaysStrategy implements GenerationStrategy {
	...
	public WW3Last14DaysStrategy() {
		this.name = "WW3Last14DaysStrategy";
		this.description = 
			...
			"Esta estrategia agrupa las lecturas de ww3 del dia actual y seis dias antes y la combina con la observacion del dia actual \n";
		
	}
	public String getShortDescription() {
		return shortDescription;
	}
	public WW3Last14DaysStrategy(String beach, String[]years, double ww3Y, double ww3X) {
		this();
		this.beach = beach;
		this.shortDescription = "strategy[WW3Last14Days].beach[" + beach + "].years " + Arrays.toString(years) + ".months[1-12].height[unrestriced].ww3.1[" + ww3Y + "," + ww3X+"]";
	}
	@Override
...
public void strategyString(Vector<Filter> ww3Filters, String[] strategyAttributes, String classAttribute){
	...
	private Vector<ArfData> mergeData(Vector<WaveWatchData> ww3DataSet, Vector<ObsData> obsDataSet){
		...
		for (int i = 13; i < ww3DataSet.size(); i++){
			...
			WaveWatchData ww3Data3DayPrev = ww3DataSet.get(i - 3);
			WaveWatchData ww3Data4DayPrev = ww3DataSet.get(i - 4);
			WaveWatchData ww3Data5DayPrev = ww3DataSet.get(i - 5);
			WaveWatchData ww3Data6DayPrev = ww3DataSet.get(i - 6);
			WaveWatchData ww3Data7DayPrev = ww3DataSet.get(i - 7);
			WaveWatchData ww3Data8DayPrev = ww3DataSet.get(i - 8);
			WaveWatchData ww3Data9DayPrev = ww3DataSet.get(i - 9);
			WaveWatchData ww3Data10DayPrev = ww3DataSet.get(i - 10);
			WaveWatchData ww3Data11DayPrev = ww3DataSet.get(i - 11);
			WaveWatchData ww3Data12DayPrev = ww3DataSet.get(i - 12);
			WaveWatchData ww3Data13DayPrev = ww3DataSet.get(i - 13);
			...
			if (obsData != null){
				...
				data.put("ww3Height4DayPrev", ww3Data4DayPrev.getHeight());
				data.put("ww3Period4DayPrev", ww3Data4DayPrev.getPeriod());
				data.put("ww3Direct4DayPrev", ww3Data4DayPrev.getDirection());
				data.put("ww3Height5DayPrev", ww3Data5DayPrev.getHeight());
				data.put("ww3Period5DayPrev", ww3Data5DayPrev.getPeriod());
				data.put("ww3Direct5DayPrev", ww3Data5DayPrev.getDirection());
				data.put("ww3Height6DayPrev", ww3Data6DayPrev.getHeight());
				data.put("ww3Period6DayPrev", ww3Data6DayPrev.getPeriod());
				data.put("ww3Direct6DayPrev", ww3Data6DayPrev.getDirection());
				data.put("ww3Height7DayPrev", ww3Data7DayPrev.getHeight());
				data.put("ww3Period7DayPrev", ww3Data7DayPrev.getPeriod());
				data.put("ww3Direct7DayPrev", ww3Data7DayPrev.getDirection());
				data.put("ww3Height8DayPrev", ww3Data8DayPrev.getHeight());
				data.put("ww3Period8DayPrev", ww3Data8DayPrev.getPeriod());
				data.put("ww3Direct8DayPrev", ww3Data8DayPrev.getDirection());
				data.put("ww3Height9DayPrev", ww3Data9DayPrev.getHeight());
				data.put("ww3Period9DayPrev", ww3Data9DayPrev.getPeriod());
				data.put("ww3Direct9DayPrev", ww3Data9DayPrev.getDirection());
				data.put("ww3Height10DayPrev", ww3Data10DayPrev.getHeight());
				data.put("ww3Period10DayPrev", ww3Data10DayPrev.getPeriod());
				data.put("ww3Direct10DayPrev", ww3Data10DayPrev.getDirection());
				data.put("ww3Height11DayPrev", ww3Data11DayPrev.getHeight());
				data.put("ww3Period11DayPrev", ww3Data11DayPrev.getPeriod());
				data.put("ww3Direct11DayPrev", ww3Data11DayPrev.getDirection());
				data.put("ww3Height12DayPrev", ww3Data12DayPrev.getHeight());
				data.put("ww3Period12DayPrev", ww3Data12DayPrev.getPeriod());
				data.put("ww3Direct12DayPrev", ww3Data12DayPrev.getDirection());
				data.put("ww3Height13DayPrev", ww3Data13DayPrev.getHeight());
				data.put("ww3Period13DayPrev", ww3Data13DayPrev.getPeriod());
				data.put("ww3Direct13DayPrev", ww3Data13DayPrev.getDirection());
