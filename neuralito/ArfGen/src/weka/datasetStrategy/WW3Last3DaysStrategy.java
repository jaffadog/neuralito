...
public class WW3Last3DaysStrategy implements GenerationStrategy {
	...
	public WW3Last3DaysStrategy() {
		this.name = "WW3Last3DaysStrategy";
		this.description = 
	...
	public WW3Last3DaysStrategy(String beach, String[]years, double ww3Y, double ww3X) {
		this();
		this.beach = beach;
		this.shortDescription = "strategy[WW3Last3Days].beach[" + beach + "].years " + Arrays.toString(years) + ".months[1-12].height[unrestriced].ww3.1[" + ww3Y + "," + ww3X+"]";
	}
	@Override
