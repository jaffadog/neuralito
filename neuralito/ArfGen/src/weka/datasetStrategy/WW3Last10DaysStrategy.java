...
public class WW3Last10DaysStrategy implements GenerationStrategy {
	...
	public WW3Last10DaysStrategy() {
		this.name = "WW3Last10DaysStrategy";
		this.description = 
	...
	public WW3Last10DaysStrategy(String beach, String[]years, double ww3Y, double ww3X) {
		this();
		this.beach = beach;
		this.shortDescription = "strategy[WW3Last10Days].beach[" + beach + "].years " + Arrays.toString(years) + ".months[1-12].height[unrestriced].ww3.1[" + ww3Y + "," + ww3X+"]";
	}
	@Override
...
public void strategyString(Vector<Filter> ww3Filters, String[] strategyAttributes, String classAttribute){
	...
	private Vector<ArfData> mergeData(Vector<WaveWatchData> ww3DataSet, Vector<ObsData> obsDataSet){
		...
		for (int i = 9; i < ww3DataSet.size(); i++){
