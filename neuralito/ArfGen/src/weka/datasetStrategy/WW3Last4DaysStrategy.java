...
public class WW3Last4DaysStrategy implements GenerationStrategy {
	...
	public WW3Last4DaysStrategy() {
		this.name = "WW3Last4DaysStrategy";
		this.description = 
	...
	public WW3Last4DaysStrategy(String beach, String[]years, double ww3Y, double ww3X) {
		this();
		this.beach = beach;
		this.shortDescription = "strategy[WW3Last4Days].beach[" + beach + "].years " + Arrays.toString(years) + ".months[1-12].height[unrestriced].ww3.1[" + ww3Y + "," + ww3X+"]";
	}
	@Override
