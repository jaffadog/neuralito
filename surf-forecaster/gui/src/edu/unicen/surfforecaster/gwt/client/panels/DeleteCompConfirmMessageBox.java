...
public class DeleteCompConfirmMessageBox extends MessageBox implements ISurfForecasterBasePanel {
	
	private Widget baseParentPanel = null;
	
	public DeleteCompConfirmMessageBox(String message, IconType iconType) {
		...
		acceptBtn.addClickHandler(new ClickHandler() {
			public void onClick(ClickEvent event) {
				((ComparationCreatorPanel)baseParentPanel).deleteComparation();
				hide();
			}
		});
