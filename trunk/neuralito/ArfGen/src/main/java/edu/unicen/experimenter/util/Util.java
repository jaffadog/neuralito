...
public final class Util {
	...
	// public static void generateResultPackage(DataSetGenerationStrategy
	// generationStrategy, String[] years, Instances wekaDataSet){
	//		
	//		
	...
	//		
	// File directory = new File(".//files//wekaResults//" +
	// generationStrategy.getName() + "//" + generationStrategy.getBeach());
	// directory.mkdir();
	//		
	...
	// creator.generateFile(directory.getPath() + "//" +
	// generationStrategy.getShortDescription() + ".arff", wekaDataSet);
	//		
	// //Save strategy description
	// FileDataIO fileWriter = new FileDataIO();
	// fileWriter.writeFile(directory.getPath() + "//StrategyDescription.txt",
