...
public class WW3Last7DaysAvgStrategy implements GenerationStrategy {
	...
	public WW3Last7DaysAvgStrategy() {
		this.name = "WW3Last7DaysAvgStrategy";
		this.description = 
	...
	public WW3Last7DaysAvgStrategy(String beach, String[]years, double ww3Y, double ww3X) {
		this();
		this.beach = beach;
		this.shortDescription = "strategy[WW3Last7DaysAvg].beach[" + beach + "].years " + Arrays.toString(years) + ".months[1-12].height[unrestriced].ww3.1[" + ww3Y + "," + ww3X+"]";
	}
	@Override
...
public void strategyString(Vector<Filter> ww3Filters, String[] strategyAttributes, String classAttribute){
	...
	private Vector<ArfData> mergeData(Vector<WaveWatchData> ww3DataSet, Vector<ObsData> obsDataSet){
		...
		for (int i = 6; i < ww3DataSet.size(); i++){
