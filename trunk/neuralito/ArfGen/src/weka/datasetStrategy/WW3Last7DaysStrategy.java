...
public class WW3Last7DaysStrategy implements GenerationStrategy {
	...
	public WW3Last7DaysStrategy() {
		this.name = "WW3Last7DaysStrategy";
		this.description = 
	...
	public WW3Last7DaysStrategy(String beach, String[]years, double ww3Y, double ww3X) {
		this();
		this.beach = beach;
		this.shortDescription = "strategy[WW3Last7Days].beach[" + beach + "].years " + Arrays.toString(years) + ".months[1-12].height[unrestriced].ww3.1[" + ww3Y + "," + ww3X+"]";
	}
	@Override
