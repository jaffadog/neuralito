...
public class SampleRemoteService_TypeSerializer implements Serializer {
  ...
  public native void deserialize(SerializationStreamReader streamReader, Object instance, String typeSignature) throws SerializationException /*-{
    var methodTable = @edu.unicen.surfforecaster.client.SampleRemoteService_TypeSerializer::methodMap[typeSignature];
    if (!methodTable) {
      @edu.unicen.surfforecaster.client.SampleRemoteService_TypeSerializer::raiseSerializationException(Ljava/lang/String;)(typeSignature);
    }
    methodTable[1](streamReader, instance);
  }-*/;
  
  public native String getSerializationSignature(String typeName) /*-{
    return @edu.unicen.surfforecaster.client.SampleRemoteService_TypeSerializer::signatureMap[typeName];
  }-*/;
