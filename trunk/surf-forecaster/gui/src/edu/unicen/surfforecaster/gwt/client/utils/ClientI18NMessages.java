...
//		this.put("USER_ID_DOES_NOT_EXIST", GWTUtils.LOCALE_CONSTANTS.USER_ID_DOES_NOT_EXIST());
		...
		this.put("NOT_ENOUGH_WEKA_INSTANCES", GWTUtils.LOCALE_CONSTANTS.NOT_ENOUGH_WEKA_INSTANCES());
		this.put("ERROR_PARSING_OBSERVATIONS_FILE", GWTUtils.LOCALE_CONSTANTS.ERROR_PARSING_OBSERVATIONS_FILE());
		this.put("CONTENT_TYPE_NOT_SUPPORTED", GWTUtils.LOCALE_CONSTANTS.CONTENT_TYPE_NOT_SUPPORTED());
		this.put("NOT_ENOUGH_WW3_HISTORY", GWTUtils.LOCALE_CONSTANTS.NOT_ENOUGH_WW3_HISTORY());
	}
}
