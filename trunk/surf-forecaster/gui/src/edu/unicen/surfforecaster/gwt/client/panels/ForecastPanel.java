...
import edu.unicen.surfforecaster.gwt.client.panels.detailedforecast.DetailedForecastWindguruTable1;
...
public class ForecastPanel extends LazyPanel {
	...
	private void showSpotLatestForecast(Map<String, List<ForecastDTO>> forecasters) {
		...
		RenderDetailedForecastContext renderContext = new RenderDetailedForecastContext(new DetailedForecastWindguruTable1(forecasters));
