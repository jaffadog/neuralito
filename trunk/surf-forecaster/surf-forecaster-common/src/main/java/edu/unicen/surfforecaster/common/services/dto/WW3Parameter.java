 ...
 * 
 */
public enum WW3Parameter implements Serializable {
	 ...
	 *
	 */
	WIND_SPEED("Wind_speed", Unit.Meterspersecond), WINDUComponent("U-component_of_wind",Unit.Meterspersecond),WINDVComponent("V-component_of_wind",Unit.Meterspersecond);;
